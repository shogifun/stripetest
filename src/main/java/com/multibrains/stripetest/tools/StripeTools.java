...
public class StripeTools {
    ...
    public ChargeCollection getChargesList() throws CardException, APIException, AuthenticationException, InvalidRequestException, APIConnectionException {
        Map<String, Object> listParams=new HashMap<>();
        listParams.put("limit",100);

        return Charge.list(listParams);
    }

    public StripeTools() throws CardException, APIException, AuthenticationException, InvalidRequestException, APIConnectionException {
